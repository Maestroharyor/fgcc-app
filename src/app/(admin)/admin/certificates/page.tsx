    ...
    <div className="px-6 md:px-10 py-10">
      ...
      <div className="mt-10 flex flex-wrap items-center gap-3">
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 font-display text-sm font-semibold text-white hover:bg-primary/90"
        >
          <Send className="h-4 w-4" aria-hidden /> Schedule &amp; send
          certificates
        </Link>
        <a
